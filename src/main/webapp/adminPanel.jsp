...
<%--    <h2>Add Vehicle</h2>--%>
<%--    <form method="post" enctype="multipart/form-data" action="admin-panel">--%>
...
<section class="admin-section">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <!-- Update Button -->
                <form action="update-vehicle" method="get" style="display: inline;">
                    <input type="hidden" name="vehicleId" value="<%= v.getVehicleId() %>">
                    <button type="submit">Update</button>
                </form>
                <!-- Delete Button -->
                <form action="delete-vehicle" method="post" style="display: inline;">
                    <input type="hidden" name="vehicleId" value="<%= v.getVehicleId() %>">
