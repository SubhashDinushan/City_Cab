...
<section class="booking-section">
    ...
    <p>Departure: <%= request.getParameter("departureDate") %></p>
    <p>Return: <%= request.getParameter("returnDate") %></p>
    <p>Passengers: <%= request.getParameter("passengers") %></p>
    <p><strong>Vehicle Type:<%= request.getParameter("vehicleType") %></p>
    <p>Total Price: <%= request.getParameter("totalPrice") %></p>
    <p>Driver: <%= request.getParameter("driverName") %></p>
    <p>Customer Name: <%= request.getParameter("cusName") %></p>
    <p>Customer Address: <%= request.getParameter("cusAddress") %></p>
    <p>Customer Email: <%= request.getParameter("cusEmail") %></p>
    <p>Customer Mobile Number: <%= request.getParameter("cusMobileNo") %></p>

    </div>

 <!-- Hidden Form to send data to the second servlet -->
   <form id="hiddenForm" action="SaveBookingServlet" method="POST" style="display: none;">
    ...
    <button type="button" onclick="submitForm()">Confirm Booking</button>
</section>
